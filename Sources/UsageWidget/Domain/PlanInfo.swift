...
struct PlanInfo: Hashable, Codable, Sendable {
    ...
    static func from(rawPlanType raw: String?) -> PlanInfo? {
        ...
        case "max", "max_5x", "max_20x", "max5x", "max20x", "claude_max": pretty = "Max"
        case "claude_pro": pretty = "Pro"
        case "claude_free": pretty = "Free"
        case "claude_team": pretty = "Team"
        case "claude_enterprise": pretty = "Enterprise"
